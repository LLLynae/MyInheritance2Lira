...
/**
 * This class represents an oval button. This means that the button will only
 * trigger
 * an acton if it is clicked within the oval shape drawn on it.
 * The button can be also of circular shape (if width=height), or capsule shape
 * (either
...
public class OvalButton extends JButton implements MouseListener, MouseMotionListener {
     ...
     *
     * @param shape                  Shape of the button. Select one of the
     *                               constants.
     * @param orientation            Orientation of the button. Select one of the
     *                               constants.
     * @param colorNormal            The main color of the button.
     * @param colorHighlighted       The color of the button when it is highlighted
     *                               (hovered over etc.).
     * @param colorBorderNormal      The main border color of the button.
     * @param colorBorderHighlighted The border color that will show whenever the
     *                               button is marked as being
     *                               highlighted (will remain this color even after
     *                               the mouse exits).
     */
    public OvalButton(int shape, int orientation, Color colorNormal, Color colorHighlighted, Color colorBorderNormal,
    ...
    /**
     * Set the thickness of the border on the button. Set to 0 if you do not want
     * any border.
     *
    ...
    /**
     *
     * @param isHighlighted True if you want this button's border to be highlighted,
     *                      false otherwise.
     */
    ...
    /**
     * This method is overridden because it adds additional checks before executing
     * the
    ...
    /**
     * Check if the position is withing the borders of the current shape of the
     * button.
     *
     * @param screenPosition Position we want to check. It must be a position on the
     *                       screen - not component dependent.
     * @return True if this point is withing the shape of the button, false
     *         otherwise.
     */
    ...
    /**
     * Should return the image that we want to set as the background. This image
     * will be
     * rendered within the oval/capsule shape of the button, but not outside of it.
     * Return null if you do not want image as the background. In this case a
     * background color
     * will be used.
     *
     ...
     * @return True if the point is within the borders or on the border of the oval,
     ...
     *
     * @param p Point to check.
     * @return True if the point is within the borders or on the border of the
     *         capsule, false if it is outside of it.
     */
    ...
    /**
     * Creates the capsule shape that corresponds to the current button state
     * (vertical/horizontal).
     *
